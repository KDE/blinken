...
highScoreDialog::highScoreDialog(QWidget *parent, QValueList< QPair<int, QString> > scores) : KDialog(parent, 0, true, WNoAutoErase), m_firstPaint(true), m_overClose(false), m_scores(scores)
{
